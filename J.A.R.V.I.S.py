...
def translate_text(text, target_language):
    ...
    target_language_code = LANGUAGES.get(target_language)
    if target_language_code:
        translated_text = translator.translate(
            text, dest=target_language_code).text
        return translated_text
    else:
        return "Language not found in the map"
        ...
        if "wake up jarvis" in query:
            ...
            while True:
                ...
                # JARVIS Introduction
                    ...
                    speak("Hello sir, My name is JARVIS, I am an open source personal voice assistant, I use speech recognition to help users in their daily tasks.")
